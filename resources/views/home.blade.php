...
<link href="cssMenuP/bootstrap.css" rel='stylesheet' type='text/css' />
<!-- jQuery (necessary JavaScript plugins) -->
<script src="jsMenuP/bootstrap.js"></script>
<!-- Custom Theme files -->
<link href="cssMenuP/style.css" rel='stylesheet' type='text/css' />
<!-- Custom Theme files -->
<!--//theme-style-->
...
<script src="jsMenuP/jquery.min.js"></script>
...
<!-- banner -->
     <!-- Slider-starts-Here -->
     <script src="jsMenuP/responsiveslides.min.js"></script>
     <script>
        $(function () {
...
<div class="content">
     <div class="container">
         ...
         <div class="top-game-grids">
             <ul id="flexiselDemo1">
                 <li>
                     <div class="game-grid">
                         ...
                         <img src="imagesMenuP/t1.jpg" class="img-responsive" alt=""/>
                     </div> 
                 </li>
                 <li>
                     <div class="game-grid">
                         <h4>Racing Games</h4>
                         <p>Nulla elementum nunc tempus.</p>
                         <img src="imagesMenuP/t3.jpg" class="img-responsive" alt=""/>
                     </div>
                 </li>
                 <li>
                     <div class="game-grid">
                         <h4>3D Games</h4>
                         <p>Nulla elementum nunc tempus.</p>
                         <img src="imagesMenuP/t4.jpg" class="img-responsive" alt=""/>
                     </div>
                 </li>
                 <li>
                     <div class="game-grid">
                         <h4>Arcade Games</h4>
                         <p>Nulla elementum nunc tempus.</p>
                         <img src="imagesMenuP/t2.jpg" class="img-responsive" alt=""/>
                     </div> 
                 </li>                                  
             </ul>
            ...
            <script type="text/javascript" src="jsMenuP/jquery.flexisel.js"></script>    
         </div>
     </div>
</div>
<!-- latest -->
                ...
                <div class="col-md-5 trailer-text">
                   <div class="sub-trailer">
                       <div class="col-md-4 sub-img">
                            <img src="imagesMenuP/v2.jpg" alt="img07"/>
                       </div>
                    ...
                    <div class="sub-trailer">
                       <div class="col-md-4 sub-img">
                            <img src="imagesMenuP/v1.jpg" alt="img07"/>
                       </div>
                       <div class="col-md-8 sub-text">
                    ...
                    <div class="sub-trailer">
                       <div class="col-md-4 sub-img">
                            <img src="imagesMenuP/v3.jpg" alt="img07"/>
                       </div>
                       <div class="col-md-8 sub-text">
     ...
     <div class="container">    
         <div class="x-box_sec">
             ...
             <div class="col-md-5 x-box-right">
                 <img src="imagesMenuP/xbox.jpg" class="img-responsive" alt=""/>
             </div>
             <div class="clearfix"></div>
         </div>
     </div>
